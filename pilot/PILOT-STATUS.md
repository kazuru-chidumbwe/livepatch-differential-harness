...
| Item | Track | Status |
| --- | --- | --- |
| 9 Peer check | `pilot/outreach/` | **Sent 2026-07-10** as Seke Kazuru — no maintainer reply; **no further list mail** |
...
Corpus items (2, 3, 7, 8) unchanged — see sponsor pilot-scope notes (private programme pack; not in this repo).
