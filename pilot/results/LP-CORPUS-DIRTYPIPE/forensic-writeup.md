...
**Role:** Option A pin smoke — harness reuse on a separate vulnerable pin (not v6.6.47).  
...
## Predicates (Option A pin smoke, 16 Aug 2026)
...
## cite-pin PRE-gated re-run (3 Sep 2026)

Closed `DIRTYPIPE_PREGATED_DONE=2026-09-03T19:55:28Z` on `boma-test` (`17-run-v020.sh`). Rebuilt bzImage SHA-256 `dccbb329c49374f41fd5960711d80b4c039f2e1c37ed4e6bc5a9869feaef338b`. Transcript: `PRE_CLASS=SOUND`, `INSMOD_RC=0`, `P2_PASS=1`, `P3_PASS=1`. See `DIRTYPIPE_PREGATED_DONE.txt` and `pin-pregated.txt`. Not byte-identical to the package `CF5C1899…` image.
