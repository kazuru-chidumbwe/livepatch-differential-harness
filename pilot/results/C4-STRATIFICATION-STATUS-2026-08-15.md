...
## Target for SoftX / Paper 2

| Deliverable | SoftX | Paper 2 |
| --- | --- | --- |
...
| INCLUDE micro-cases executed | Optional SoftX depth | Required |
...
SoftX may cite the **bounded sample table** and state full stratification is ongoing. Do not claim complete 6.1.y coverage until the table says so.
