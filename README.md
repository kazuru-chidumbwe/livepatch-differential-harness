...
**Public pin:** https://github.com/kazuru-chidumbwe/livepatch-differential-harness · SemVer **`v0.1.3`** (see `CITATION.cff`, [`docs/TAGS.md`](docs/TAGS.md), [`CHANGELOG.md`](CHANGELOG.md), [`docs/ZENODO.md`](docs/ZENODO.md), [`RELEASE_MANIFEST.yaml`](RELEASE_MANIFEST.yaml))  
**Status:** package **case study on v6.6.47** — instrument + illustrative corpus; not a stratified prevalence study. Historical package pin `softwarex-lp1-20260725c` remains a freeze anchor. Prior SemVer `v0.1.1` kept as history.  
