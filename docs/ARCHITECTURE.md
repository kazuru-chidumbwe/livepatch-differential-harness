...
LivepatchDiff case-study pin: Linux **v6.6.47**. This document is the operator-facing API for adapting the harness beyond the illustrative corpus.
...
## What stays manual (honest LivepatchDiff scope)
