...
| Tag | Commit | Purpose |
| --- | --- | --- |
| [`v0.1.0`](https://github.com/kazuru-chidumbwe/livepatch-differential-harness/releases/tag/v0.1.0) | `386226e` | First SemVer release (same tree as LivepatchDiff pin) |
| [`softwarex-lp1-20260725c`](https://github.com/kazuru-chidumbwe/livepatch-differential-harness/tree/softwarex-lp1-20260725c) | `386226e` | LivepatchDiff case-study pin (canonical) |
...
- LivepatchDiff dated pin → `softwarex-lp1-20260725c` (same tree as `v0.1.0`).
