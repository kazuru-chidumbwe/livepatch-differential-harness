...
| Tag | Commit | Purpose |
| --- | --- | --- |
| [`v0.1.1`](https://github.com/kazuru-chidumbwe/livepatch-differential-harness/releases/tag/v0.1.1) | `aaa34e3` (tag also includes `b7adce7` TAGS pin) | package cite pin · C3 structural refresh · Zenodo capsule |
...
- **SemVer / package C1 / CITATION.cff** → `v0.1.1` (see [`CHANGELOG.md`](../CHANGELOG.md)).
