...
| Tag | Commit | Purpose |
| --- | --- | --- |
| [`v0.2.0`](https://github.com/kazuru-chidumbwe/livepatch-differential-harness/releases/tag/v0.2.0) | *(tip at tag)* | ** cite pin** · full-pipeline · PRE + Dirty Pipe + 6 INCLUDE + v6.1.119 + PRE N=24 |
