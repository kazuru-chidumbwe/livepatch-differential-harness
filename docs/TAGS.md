...
| Tag | Commit | Purpose |
| --- | --- | --- |
| [`v0.2.2`](https://github.com/kazuru-chidumbwe/livepatch-differential-harness/releases/tag/v0.2.2) | (tag at release) | Stanford minor-rev: structural oracle docs, contract YAML, Host B timing suite |
