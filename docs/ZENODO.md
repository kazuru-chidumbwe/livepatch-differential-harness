...
**Cite pin:** `v0.1.1`  
**Venue:** SoftwareX (tool / case-study instrument)  
**GitHub tree (SoftwareX C2):** https://github.com/kazuru-chidumbwe/livepatch-differential-harness/tree/v0.1.1  

**Version DOI:** _pending mint_  
**Concept DOI:** _pending mint_

## SoftwareX Code metadata (capsule)
...
**Do not mint until `.zenodo.json` notes say SoftwareX** (not SCP). After DOI exists, paste into this file, `CITATION.cff`, and the SoftwareX manuscript Code metadata / docs link.
