...
package case-study pins (`softwarex-lp1-*`) remain valid reproducibility anchors.
Prefer **SemVer** (`vX.Y.Z`) for package C1 / CITATION.cff; see [`docs/TAGS.md`](docs/TAGS.md).
